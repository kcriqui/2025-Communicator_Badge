...
class SX126X:
    ...
    def __init__(self, spi_host, sck, mosi, miso, cs, irq, rst, gpio):
        self._irq = irq
        ## Begin LVGL-Micropython specific stuff here
        
        self.spi_bus = SPI.Bus(host=spi_host, sck=sck, mosi=mosi, miso=miso)
        self.spi = SPI.Device(spi_bus=self.spi_bus, freq=2000000, cs=cs)
        
        ## end LVGL-Micropython specific stuff here
